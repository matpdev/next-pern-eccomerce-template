          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 'bg-slate-900'`}>
                <NavLink end to="/admin" className={`block text-slate-200 hover:text-white truncate transition duration-150 hover:text-slate-200`}>
                  <div className="flex items-center">
                    <FontAwesomeIcon icon={faGauge} style={{ fontSize: "20px"}}/>
                      ...
                      <a href="#0" className={`block text-slate-200 hover:text-white truncate transition duration-150 ${pathname.includes('ecommerce') && 'hover:text-slate-200'}`} onClick={(e) => { e.preventDefault(); sidebarExpanded ? handleClick() : setSidebarExpanded(true) }}>
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex shrink-0 ml-2">
                            <FontAwesomeIcon icon={faChartLine} style={{ fontSize: "20px", transform: `${open && 'transform rotate-180'}`}}/>
                          </div>
                        </div>
                      </a>
