...
function Help() {
  ...
  return (
    <div className="relative inline-flex ml-3">
      ...
      >
        <span className="sr-only">Precisa de Ajuda?</span>
      ...
      >
        ...
        >
          <div className="text-xs font-semibold text-slate-400 uppercase pt-1.5 pb-2 px-4">Precisa de Ajuda?</div>
          <ul>
            <li>
              <Link
